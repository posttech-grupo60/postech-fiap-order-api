...
describe('Memory Repository Product', () => {
    ...
    test('Should create customer', async () => {
        const memoryCustomerRepository = new MemoryCustomerRepository();
        const newCustomer = new Customer('1','João da Silva',new CPF('819.987.999-80'));
    ...
    test('Should get product by id', async () => {
        const memoryCustomerRepository = new MemoryCustomerRepository();
        const newCustomer1 = new Customer('1','João da Silva',new CPF('819.987.999-80'));
        const newCustomer2 = new Customer('1','João da Silva',new CPF('777.637.071-19'));
